...
async function loadProfile() {
  try {
    profile = await browser.runtime.sendMessage({ type: MessageTypes.GET_PROFILE });
...
async function saveProfile() {
  ...
  try {
    await browser.runtime.sendMessage({ type: MessageTypes.SAVE_PROFILE, payload: profile });
    showSaveIndicator();
  } catch (error) {
