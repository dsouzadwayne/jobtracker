...
export async function loadDashboardSettings() {
  try {
    ...
    dashboardSettings = await browser.runtime.sendMessage({ type: 'GET_SETTINGS' });
...
async function saveAutofillSettings() {
  ...
  await browser.runtime.sendMessage({ type: 'SAVE_SETTINGS', payload: dashboardSettings });
  ...
  if (preloadBtn) {
    preloadBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        const modelsStatus = await browser.runtime.sendMessage({
