...
async function loadApplications() {
  try {
    const response = await browser.runtime.sendMessage({ type: MessageTypes.GET_APPLICATIONS });
...
async function loadSettings() {
  try {
    const response = await browser.runtime.sendMessage({ type: MessageTypes.GET_SETTINGS });
    settings = response || {};
...
async function saveGoals(e) {
  ...
  await browser.runtime.sendMessage({ type: MessageTypes.SAVE_SETTINGS, payload: settings });
...
async function loadUpcomingInterviews() {
  ...
  try {
    const response = await browser.runtime.sendMessage({ type: MessageTypes.GET_INTERVIEWS });
...
async function loadTasks() {
  ...
  try {
    const response = await browser.runtime.sendMessage({ type: MessageTypes.GET_TASKS });
