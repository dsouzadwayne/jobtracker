...
(function() {
  ...
  function createFloatingButton() {
    ...
    // Close menu when clicking elsewhere - use AbortController for cleanup
    ...
    // Make draggable
    makeDraggable(floatingButton, buttonAbortController.signal);
  }
  ...
  async function handleIApplied() {
    if (hasApplied || isTrackingJob) return;
    isTrackingJob = true;
  ...
  function makeDraggable(element, signal) {
  ...
  function observeLinkedInJobChanges() {
    ...
    linkedInObservers.push(jobListObserver);
