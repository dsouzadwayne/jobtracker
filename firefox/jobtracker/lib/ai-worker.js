...
async function loadTransformers() {
  ...
  try {
    ...
    // Firefox: Disable multi-threading to avoid nested Worker issues
    // ONNX Runtime's proxy workers fail in Firefox extension Worker contexts
    // (CSP inheritance and SharedArrayBuffer availability issues with nested Workers)
