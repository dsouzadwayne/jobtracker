      ...
      <div class="app-card-main">
        ...
        <div class="app-info">
          ...
          <div class="app-meta">
            ...
            ${app.platform && app.platform !== 'other' ? `<span class="app-meta-item">${capitalizeStatus(app.platform)}</span>` : ''}
          </div>
        </div>
      </div>
      <div class="app-card-actions">
        <span class="status-badge ${statusClass}" data-action="status">${capitalizeStatus(app.status)}</span>
    ...
    <div class="app-card-details">
      <div class="app-details-grid">
        ...
        ${app.jobType ? `<div class="app-detail-item">
          ...
          <div class="app-detail-value">${capitalizeStatus(app.jobType)}</div>
        </div>` : ''}
        ${app.remote ? `<div class="app-detail-item">
          <div class="app-detail-label">Remote</div>
          <div class="app-detail-value">${capitalizeStatus(app.remote)}</div>
        </div>` : ''}
          ...
          <div class="status-timeline">
            ${app.statusHistory.slice().reverse().map(entry => `
              <div class="status-timeline-item">
                <strong>${capitalizeStatus(entry.status)}</strong>
                <div class="status-timeline-date">${formatDate(entry.date)}</div>
